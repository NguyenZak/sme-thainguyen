  ...
  return (
    <form onSubmit={handleSave} className="space-y-6 max-w-4xl">
      <div className="flex items-center justify-between border-b border-slate-800 pb-4">
        <div>
          <h2 className="text-xl font-bold text-white">Hero Banner & Đồng Hồ Đếm Ngược</h2>
          <p className="text-xs text-slate-400">Thay đổi tiêu đề chính, phụ đề, các từ khóa gõ chữ tự động và thời gian đếm ngược.</p>
        </div>
        <button
          type="submit"
          disabled={saving}
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-4">
        <h3 className="text-sm font-bold text-emerald-400 uppercase tracking-wider">TIÊU ĐỀ & HUY HIỆU (BADGE)</h3>

        <div>
          <label className="block text-xs font-medium text-slate-300 mb-1">Thẻ Huy Hiệu (Top Badge Text)</label>
          <input
            type="text"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-xs font-medium text-slate-300 mb-1">Tiêu Đề Dòng 1 (Main Title)</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-xs font-medium text-slate-300 mb-1">Tiêu Đề Dòng 2 (Subtitle/Highlight)</label>
            <input
              type="text"
              value={hero.subTitle}
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <label className="block text-xs font-medium text-slate-300">Danh Sách Từ Khóa Động (Hiệu ứng Gõ Chữ)</label>
            <button
              type="button"
              onClick={addKeyword}
      ...
      {/* Thời gian & Địa điểm */}
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-4">
        <h3 className="text-sm font-bold text-emerald-400 uppercase tracking-wider">THỜI GIAN SỰ KIỆN & COUNTDOWN</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-xs text-emerald-400 focus:border-emerald-500 focus:outline-none font-semibold cursor-pointer [color-scheme:dark]"
            />
            <p className="text-[11px] text-slate-400 mt-1">
              Định dạng hiện tại: <span className="font-mono text-emerald-300">{hero.targetDateISO}</span>
            </p>
          </div>

          <div>
            <label className="block text-xs font-medium text-slate-300 mb-1">Văn Bản Hiển Thị Ngày Sự Kiện</label>
            <input
              type="text"
          ...
          <div className="md:col-span-2">
            <label className="block text-xs font-medium text-slate-300 mb-1">Địa Điểm Tóm Tắt (Hero Venue)</label>
            <input
              type="text"
      ...
      {/* Các Nút Bấm Action */}
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-4">
        <h3 className="text-sm font-bold text-emerald-400 uppercase tracking-wider">CÁC NÚT BẤM KÍCH HOẠT (CTA BUTTONS)</h3>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-3 bg-slate-950 rounded-xl border border-slate-800/80 space-y-2">
            <span className="text-[11px] font-semibold text-emerald-400">Nút Chính 1 (Đăng ký)</span>
            <input
              type="text"
          ...
          <div className="p-3 bg-slate-950 rounded-xl border border-slate-800/80 space-y-2">
            <span className="text-[11px] font-semibold text-teal-400">Nút Phụ 2 (Tài trợ)</span>
            <input
              type="text"
          ...
          <div className="p-3 bg-slate-950 rounded-xl border border-slate-800/80 space-y-2">
            <span className="text-[11px] font-semibold text-cyan-400">Nút Phụ 3 (Gian hàng)</span>
            <input
              type="text"
