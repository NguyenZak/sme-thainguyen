  ...
  return (
    <div className="space-y-6 max-w-4xl pb-16">
      <div className="flex items-center justify-between border-b border-slate-200 pb-4">
        <div>
          <h2 className="text-xl font-bold text-slate-900">07 · Diễn Giả &amp; Khách Mời VIP (Keynote Speakers)</h2>
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            type="button"
            onClick={addSpeaker}
            className="inline-flex items-center gap-1 text-xs text-slate-900 hover:text-black font-bold bg-slate-100 hover:bg-slate-200 px-3 py-1.5 rounded-xl border border-slate-300 transition-colors cursor-pointer"
          >
                ...
                <div className="sm:col-span-9 space-y-2.5">
                  ...
                  <div>
                    <RichTextarea
                      ...
                      onChange={(val) => handleItemChange(idx, "achievements", val)}
                      rows={2}
                  ...
                  <div>
                    <RichTextarea
                      label="Vì sao nên nghe"
                      value={spk.whyListen || ""}
                      onChange={(val) => handleItemChange(idx, "whyListen", val)}
                      rows={2}
                  ...
                  <div>
                    <RichTextarea
                      label="Giá trị bài nói"
                      value={spk.speechValue || ""}
                      onChange={(val) => handleItemChange(idx, "speechValue", val)}
                      rows={2}
