      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-5 space-y-4 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <div className="w-full bg-amber-50 border border-amber-200 rounded-xl px-3.5 py-2.5 text-[11px] text-amber-900 leading-relaxed">
              🔒 Vì bảo mật, Bot Token được đặt trong biến môi trường
              <code className="font-mono font-bold"> TELEGRAM_BOT_TOKEN</code> trên hosting
              (không nhập trong CMS để tránh lộ token công khai).
            </div>
          </div>
