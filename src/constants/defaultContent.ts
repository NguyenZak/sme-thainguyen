...
export const DEFAULT_ABOUT: AboutContent = {
  ...
  attendeesSubtitle: "Hội tụ lãnh đạo từ Chính phủ, doanh nghiệp hàng đầu và nhà đầu tư quốc tế trong 2 ngày sự kiện.",
...
export const DEFAULT_TIMELINE: TimelineContent = {
  ...
  title: "Chương Trình Chi Tiết 2 Ngày Diễn Đàn",
  subtitle: "Chuỗi hoạt động phong phú gồm Triển lãm, Diễn đàn cấp cao, B2B Matching, Gala Dinner và Đại hội TASME.",
  bannerEyebrow: "✦ Quy mô sự kiện · 2 ngày sôi động ✦",
  bannerDateText: "19 – 20 / 09 / 2026",
  ...
  days: [
    {
      ...
      dayTitle: "Ngày 01",
      dateText: "19/09/2026",
      subTitle: "Diễn đàn SME Việt Nam 2026 & Gala Dinner",
    ...
    },
    {
      ...
      dayTitle: "Ngày 02",
      dateText: "20/09/2026",
      subTitle: "Đại hội Hiệp hội Doanh nghiệp NV Tỉnh Thái Nguyên",
      location: "May Plaza Hotel Thái Nguyên",
    },
  ],
  slots: [
    // Ngày 01 (19/09/2026)
    {
      ...
      title: "KHAI MẠC DIỄN ĐÀN",
      location: "Sảnh VIP May Plaza",
      description: "• Tuyên bố lý do, giới thiệu đại biểu.\n• Trình chiếu video giới thiệu: “Thái Nguyên – Điểm đến đầu tư, đổi mới sáng tạo và liên kết phát triển”.\n• Phát biểu khai mạc của đại diện Ban Tổ chức.\n• Phát biểu chào mừng của lãnh đạo Trung ương và/hoặc lãnh đạo tỉnh Thái Nguyên.",
      highlight: true,
    },
    {
      id: "ts-2",
      ...
      title: "LỄ TRÀ KẾT NỐI – TEA CONNECTION CEREMONY",
      location: "Khách sạn May Plaza",
      description: "Chủ đề: “Một chén trà – Muôn vàn kết nối”",
    },
    {
      id: "ts-3",
      dayNumber: 1,
      ...
      location: "Khách sạn May Plaza",
      description: "Chủ đề: Doanh nghiệp nhỏ và vừa Việt Nam trong kỷ nguyên tăng trưởng xanh, chuyển đổi số và hội nhập quốc tế.",
    },
    {
      id: "ts-4",
      dayNumber: 1,
      dayTitle: "Ngày 01",
      timeSlot: "16:15 – 16:40",
      title: "DIỄN ĐÀN CẤP CAO 1",
      location: "Khách sạn May Plaza",
      description: "Chủ đề: Xúc tiến đầu tư và tài chính.",
    },
    {
      id: "ts-5",
      dayNumber: 1,
      dayTitle: "Ngày 01",
      timeSlot: "16:40 – 17:05",
      title: "DIỄN ĐÀN CẤP CAO 2",
      location: "Khách sạn May Plaza",
      description: "Chủ đề: AI, chuyển đổi số, thương mại điện tử, liên kết vùng, xúc tiến thương mại và hợp tác quốc tế cho SME.",
    },
    {
      id: "ts-6",
      dayNumber: 1,
      dayTitle: "Ngày 01",
      timeSlot: "17:05 – 17:30",
      title: "PHIÊN ĐỐI THOẠI",
      location: "Khách sạn May Plaza",
      description: "Chủ đề: Chính quyền – Doanh nghiệp – Nhà đầu tư",
    },
    {
      id: "ts-7",
      dayNumber: 1,
      ...
      location: "Khách sạn May Plaza",
      description: "Ký kết các Biên bản Ghi nhớ Hợp tác (MOU) và thỏa thuận đầu tư giữa các doanh nghiệp & đối tác.",
    },
    {
      id: "ts-8",
      dayNumber: 1,
      ...
      title: "CÔNG BỐ KẾT QUẢ DIỄN ĐÀN & NGHI THỨC TRAO CỜ ĐĂNG CAI",
      location: "Khách sạn May Plaza",
      description: "Trao cờ đăng cai tổ chức Diễn đàn lần tiếp theo cho tỉnh Phú Thọ.",
    },
    {
      id: "ts-9",
      dayNumber: 1,
      dayTitle: "Ngày 01",
      timeSlot: "18:15 – 18:30",
      title: "BẾ MẠC DIỄN ĐÀN",
      location: "Khách sạn May Plaza",
      description: "Tổng kết các kết quả đạt được tại phiên diễn đàn giao thương.",
    },
    {
      id: "ts-10",
      dayNumber: 1,
      ...
      location: "Trung tâm Sự kiện May Plaza",
      description: "Chào mừng Đại hội và vinh danh các nhà tài trợ, đối tác, chương trình nghệ thuật đặc sắc.",
      highlight: true,
    },
    {
      id: "ts-11",
      ...
      location: "Hội trường Trọng tâm May Plaza",
    ...
    },
    {
      ...
      title: "Tiệc trưa Networking & Chúc mừng Đại hội thành công",
      location: "Nhà hàng Khách sạn May Plaza",
      description: "Dùng bữa trưa thân mật, giao lưu kết nối doanh nghiệp và tiễn đoàn đại biểu.",
    },
  ],
};
...
export const DEFAULT_TICKET_FEE: TicketFeeContent = {
  ...
  subtitle: "Trọn gói quyền lợi tham dự chuỗi hoạt động 2 ngày tại Thái Nguyên (Đã bao gồm 02 Đại biểu & 01 Gian hàng).",
  priceVND: 3000000,
